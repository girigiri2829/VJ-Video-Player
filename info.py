...
ADMIN = int(environ.get('ADMIN', '2135601715 1781188088'))
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1003790203800'))
...
LINK_URL = environ.get("LINK_URL", "https://gicartoonsnetwork.blogspot.com/p/g.html")
